...
function OwnerChangeCF() {
  ...
  const transferOwner = async () => {
    ...
    await contractCoinFog.transferOwnership(newAddress);
  ...
  return (
    <div>
      <button onClick={transferOwner} className='button4'>Change Owner CoinFog</button>
